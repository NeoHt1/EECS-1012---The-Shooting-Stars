...
const QUESTION_BANK = [
  ...
  { id: "q7", text: "In The Cat in the Hat who is thr voice of repsonsibility?:", choices: ["The Fish", "The Dog", "Sally", "The Cat"], answerIndex: 0, hint: "Metis over might." },
  ...
  { id: "q17", text: "A young boy discovers he’s a wizard on his 11th birthday.", choices: ["Percy Jackson and the Lightning Thief", "Harry Potter and the Sorcerer’s Stone", "The Hobbit", "Artemis Fowl: The Atlantis Complex"], answerIndex: 1, hint: "Guest-friend rules matter." },
  ...
  { id: "q24", text: "In this society, people are divided into factions based on virtues.", choices: ["Legend", "Amulet: The Stonekeeper", " The Maze Runner", "Divergent"], answerIndex: 3, hint: "The narrator famously begins with “Call me Ishmael.”" },
  { id: "q25", text: "A brilliant girl uses telekinesis to fight her cruel headmistress.", choices: ["Coraline", "Matilda", "James and the Giant Peach", " The Witches"], answerIndex: 1, hint: "The narrator famously begins with “Call me Ishmael.”" },
  ...
  { id: "q29", text: "A boy wins a golden ticket to visit a magical chocolate factory.", choices: ["The BFG", "Charlie and the Chocolate Factory", "Big Nate", "Goosebumps: The Blob that ate everything"], answerIndex: 1, hint: "The spider writes words in her web." },
  ...
  { id: "q32", text: "Which one of these is not a real book? ", choices: ["Cooking with Poo", "Training Unicorns to Tap Dance", "Do Penguins Have Knees?", "How to Traumatize Your Children"], answerIndex: 1, hint: "Cooking With Poo is a real book and it was written by Bangkok chef Saiyuud Diwong, whose nikcname is Poo (Thai for 'crab')" },
  { id: "q33", text: "Which one of these is not a real book? ", choices: ["Franklin Goes to School", "Diary of a Wimpy Kid", "Wonder", "Thirteen Reasons Why"], answerIndex: 2, hint: "This book is about a boy who was born with facial differences and the challenges he faces after switching from being homeschooled to going to public school." },
...
document.getElementById("submitBtn").addEventListener("click", () => {
  ...
  location.replace(`resultsPage.html?score=${score}&total=${currentQuestions.length}`);
});

//reset button
document.getElementById("resetBtn").addEventListener("click", () => {
  //  loads a new random 10 when submit button is clicked
  currentQuestions = pickRandomQuestions(QUESTION_BANK, 10);
  renderQuiz(currentQuestions);
});
